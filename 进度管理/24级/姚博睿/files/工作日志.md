...
## 进度
- 修改了原本buff功能中大符模式下不能同时识别两个目标物的情况，适应比赛规则
- 研究mpc模型控制预测，辅助云台平滑预测，避免跳变，虽然能量机关本来就是跳变的目标，但是可以避免云台抖动。

### 能量机关使用说明
现在能量机关的灯效完善度特别高，在这里留一个tip：
- 长按1号符外围第一个灯板进入setting
- 由圆心向外，从第四个开始是蓝大蓝小，红大红小
- 由圆心向外第三个可以更改大符的符叶间隔
